...
ci:
	...
	-t harbor.longguikeji.com/ark-releases/test:$(VERSION) .
...
docker-dev-build:
	docker build -t harbor.longguikeji.com/ark-releases/test:$(VERSION) .

docker-dev-push:
	docker push harbor.longguikeji.com/ark-releases/test:$(VERSION)
